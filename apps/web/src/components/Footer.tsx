      ...
      <div className="mx-auto max-w-screen-2xl px-4 py-10">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className={COL_CLASS}>
            <h4 className="text-ink font-semibold">Company</h4>
          ...
          <div className={COL_CLASS}>
            <h4 className="text-ink font-semibold">Account</h4>
            <ul className="space-y-2">
          ...
          <div className={COL_CLASS}>
            <h4 className="text-ink font-semibold">Corporate</h4>
            <ul className="space-y-2">
          ...
          <div className={COL_CLASS}>
            <h4 className="text-ink font-semibold">Popular</h4>
            <ul className="space-y-2">
